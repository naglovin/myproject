...
class UserForm(forms.Form):
    ...
    def clean_name(self):
        """Плохойпример.Подменапараметраmin_length."""
...
class ManyFieldsForm(forms.Form):
    ...
    is_active=forms.BooleanField(required=False)  # (required=False говорит о том что поле не обязательное, tru обязательно
